(function () {
	...
	onvisible.add('#text02', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 125, state: true, replay: false });
	onvisible.add('#text03', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 250, state: true, replay: false });
	onvisible.add('#buttons02', { style: 'fade-right', speed: 1000, intensity: 7, threshold: 3, delay: 0, stagger: 125, staggerOrder: 'reverse', staggerSelector: ':scope > li', state: true, replay: false });
	onvisible.add('#image01', { style: 'fade-left', speed: 1250, intensity: 4, threshold: 3, delay: 125, state: true, replay: false });
	onvisible.add('#container01', { style: 'flip-right', speed: 1500, intensity: 0, threshold: 3, delay: 0, state: true, replay: false });
	onvisible.add('#icons07', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 250, stagger: 125, staggerOrder: 'reverse', staggerSelector: ':scope > li', state: true, replay: false });
